# A simple example of PyTorch distributed training across multiple nodes
# Written by Lei Mao: https://leimao.github.io/blog/PyTorch-Distributed-Training/
...
def main():
    ...
    train_loader = DataLoader(dataset=train_set, batch_size=batch_size, sampler=train_sampler, num_workers=6)
    # Test loader does not have to follow distributed sampling strategy
    test_loader = DataLoader(dataset=test_set, batch_size=128, shuffle=False, num_workers=6)
